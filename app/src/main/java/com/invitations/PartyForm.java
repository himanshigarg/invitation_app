...
public class PartyForm extends Activity implements View.OnClickListener{
    public EditText date,time,venue,description;
    ...
    public void onClick(View v) {
        ...
        try {
            Intent i = new Intent(PartyForm.this, Party_template.class);
